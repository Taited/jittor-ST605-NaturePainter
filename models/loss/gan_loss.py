# This code is a re-implementation of MMGeneration
# Please refer to https://github.com/open-mmlab/mmgeneration
...
class GANLoss(nn.Module):
    ...
    def _wgan_logistic_ns_loss(self, input, target):
        ...
        return nn.softplus(-input).mean() if target else nn.softplus(
            input).mean()
