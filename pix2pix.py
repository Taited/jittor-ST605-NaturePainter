...
parser.add_argument("--data_path", type=str, default="./dataset/FlickerSeg2Img")
...
os.makedirs(f"{opt.output_path}/training_samples/", exist_ok=True)
os.makedirs(f"{opt.output_path}/ckpt/", exist_ok=True)
os.makedirs(f"{opt.output_path}/tf_logs/", exist_ok=True)

writer = SummaryWriter(f"{opt.output_path}/tf_logs")
